...
import  HeroImage  from "../../src/assets/Image1.jpg"
  ...
  return (
    <div className="relative min-h-[110vh] bg-gradient-to-b from-gray-50 to-white pb-0">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-lg sm:text-xl text-gray-800 text-semibold mb-8 max-w-2xl mx-auto">
              안전하고 효율적인 태양광 설비부터 유지보수까지, 전문가들이
              함께합니다.
            </p>
          ...
          <div className="flex-1 w-full max-w-2xl lg:max-w-none">
            <div className="relative">
              <img src={HeroImage} className="realative rounded-2xl shadow-2xl w-full object-cover transform hover:scale-[1.02] transition-transform duration-300"/>
            </div>
          </div>
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 max-w-4xl mx-auto my-5">
          {[
            { number: "1,200+", label: "설치완료" },
