...
import Human1 from "../../src/assets/Human1.jpg";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((teamMembers, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">{teamMembers.name}</h3>
                <p className="text-indigo-600 font-semibold mb-4">{teamMembers.position}</p>
                <p className="text-gray-600">{teamMembers.description}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {executives.map((executives, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-2xl font-bold text-gray-800 mb-2">{executives.name}</h3>
                <p className="text-indigo-600 font-semibold mb-4">{executives.position}</p>
                <p className="text-gray-600">{executives.description}</p>
              </div>
            </div>
          ))}
        </div>
