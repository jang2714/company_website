...
import companyImage from "../../src/assets/Image2.jpg"
  ...
  return (
    <div className='container mx-auto px-4 py-32 max-w-7xl'>
      <div className='relative rounded-2xl overflow-hidden shadow-2xl mb-24'>
        ...
        <div className='absolute bottom-8 left-8 mb:bottom-12 md:left-12 text-white'>
          <h3 className='text-2xl md:text-4xl font-bold mb-2 md:mb-3'>ABC Company</h3>
          <p className='text-base md:text-xl font-light'>혁신과 신뢰로 글로벌 시장을 선도합니다.</p>
        </div>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-10 mb-24'>
        {
          [
            ...
            <div key={index} className='bg-white p-10 rounded-xl shadow-lg text-center hover:shadow-2xl transition-all duration-300 border-gray-100'>
      ...
      <div className='mb-24 max-w-4xl mx-auto text-center'>
        ...
        <p className='text-2xl leading-relaxed text-gray-600 font-light'>
          "2023년까지 글로벌 시장을 선도하는 기술 혁신 기업으로 도약하여, <br/>더 나은 세상을 만드는데 기여하겠습니다."
        </p>
      </div>
